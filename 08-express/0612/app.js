...
app.set(`views`, `./views`); // view폴더 안에 ejs문법으로 만들어진 파일. 


// app.get(`/`, function(req, res) { // 바로 화면에 출력할 때
//     res.send(`Hello Express`);
// })

// 브라우저에 처음 접속했을 때
app.get(`/`, (req, res) => { // ejs로 출력할 때
    res.render(`index`); // 랜더링: 화면에 나타나게 해줌.
})
