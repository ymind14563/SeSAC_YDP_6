...
// 마지막에 할당된 값이 저장되면서 코드를 혼동 시킬 수 있음.
...
//      - ex) let, var, const, void, return, for, while, class 등등
// - 숫자로 시작 불가능
// - 특수문자 : _ $ 만 사용 가능 나머지 불가능
// - 공백 문자 (space bar) 사용 불가능

// Q) 식별자에 단어 두개 이상 작성하고 싶은 경우?
// A) (관례)
// camelCase    ex) redApple, isWater
// snake_case   ex) red_apple, is_water

// Q) 상수란?
// A) 프로그램이 실행하는 동안 값이 변하지 않는 데이터를 나타냅니다.
// 한번 정의되면 프로그램 실행 중에 는 변경되지 않아야 함. (고정된 값)
// 보통 대문자로 표기함. (개발자 커퓨니케이션내에서 규칙)
// ex) TOMATO, APPLE ..
/////////////////////////////////////////////