 ...
 * - 자동 생성 : createSlice를 사요하면 액션 타입이 자동으로 생성
...
// export default counterSlice.reducer; 에서 counterSlice.reducer는 createSlice에 의해 자동으로 생성된 리듀서 함수
// 상태 업데이트를 담당, 핵심 함수이기 때문에 default로 내보내는 것
// 객체에서 reducers 라고 정의했는데 이름에 s를 붙이지 않고 단수형 reducer를 사용하는 이유는 슬라이스에서 단일 리듀서 함수를 반환하기 때문