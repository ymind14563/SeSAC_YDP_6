...
export default class ClassBind extends Component {
     ...
     * (자신만의 this를 가지지 않음, this 사용 시 상위 스코프를 의미하게 됨)
     */
    ...
    printConsole2 = (evt, msg, e) => {
        ...
        console.log("msg >>> ", msg);
        console.log("e >>> ", e);
        console.log("this >>> ", this); // 클래스 인스턴스 (Classbind, 상위스코프의 this를 의미)
    }
  ...
  render() {
    return (
      <div>
        ...
        {/* 함수에 인자가 있는 함수 */}
        {/* 이벤트 객체만 전달 */}
        {/* 이벤트 객체 자체만을 전달하고 추가로 전달된 인자는 undefined 출력됨 */}
